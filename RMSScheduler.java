 ...
 * 
 */
public class RMSScheduler extends Application {
    ...
    public void start(Stage primaryStage) {
            ...
            public void handle(ActionEvent e){
               ...
               Process fPirority,sPirority,thPirority;
                ...
                while(i<lcm){
                    ...
                    start +=sector;
                    {
                    excutable = calcRMS(proc1,proc2,proc3,i);
                    if(excutable==proc1){
                        fTime--;
                        if(fTime==0){
                                fTime = proc1.time;
        ...
        primaryStage.setTitle("RMS scheduling");
    ...
    public Process calcRMS(Process p1, Process p2, Process p3,int i){
        if(p1.state=="ready")   
            return p1; 
        else if(p2.state=="ready")      
            return p2;        
        else if(p3.state=="ready"||p3.state=="executing")   
            return p3;       
        else      
            return null;
    }
